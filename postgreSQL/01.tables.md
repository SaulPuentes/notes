...
The following code creates a school database that includes a variaty of data types and constraints that will be explained in this document.

```sql
BEGIN;

-- IF NOT EXISTS is an optional statement
-- public is the default schema of postgreSQL
...
(
    ...
    birthday date,
    gender boolean,
    PRIMARY KEY (id) -- specify the primary key
);
